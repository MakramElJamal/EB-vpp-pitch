...
const STEPS = [
  {
    headline: "JOD 35 a month. We only earn more when you save more.",
    body: "A flat JOD 35 per site per month — a rounding error on a large electricity bill, never a budget conversation. On top of that, we take 10% of whatever we save the customer. If the saving doesn't materialise, the extra fee doesn't either. No risk for the customer. Fully aligned incentives for us.",
  },
  {
    headline: "A typical site saves JOD 400–1,200 a month. We earn JOD 75–155 of that.",
      ...
      <div className="chapter-inner">
        ...
        <div ref={stepsRef} className="lg:col-start-1 lg:row-start-1">
          <div data-snap className="min-h-[35vh] flex flex-col justify-end pb-12 px-8 lg:px-12">
            ...
            <h2 className="display-heading text-4xl lg:text-5xl text-primary">Business Model</h2>
          </div>
